...
function Nav(props) {
  ...
  const toggle = () => {
    setNavbarClass(
      navbarstate ? "collapse navbar-collapse" : "collapse navbar-collapse show"
    );
      ...
      <nav class="navbar navbar-expand-lg ">
        <NavLink class="navbar-brand ml-5" to="/">
          <img
            ...
            alt=""
            className="logo"
            style={{ color: `${props.color}`, filter: `${props.filter}` }}
          />
        </NavLink>
        <button
        ...
        <div class={navbarClass} id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ml-auto mr-5 d-flex  justify-content-around">
            ...
            <li className="nav-item">
              <NavLink
                to="/login"
                className="nav-link btn btn-warning text-dark p-2 btn-login"
              >
                Login
              </NavLink>
            </li>
